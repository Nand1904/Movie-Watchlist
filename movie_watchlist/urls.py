...
urlpatterns = [
    ...
    path('add_movie_to_watchlist/<int:movie_id>/', views.add_movie_to_watchlist, name='add_movie_to_watchlist'),  # Define the URL pattern for the add_movie_to_watchlist view here
